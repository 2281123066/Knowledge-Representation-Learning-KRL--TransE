...
if __name__ == '__main__':
    dirTrain = "E:\\workplace_kdh\\KG\data\\WN18\\train.txt"
    tripleNumTrain, tripleListTrain = openD(dirTrain)
    dirTest = "E:\\workplace_kdh\\KG\data\\WN18\\test.txt"
    tripleNumTest, tripleListTest = openD(dirTest)
    dirEntityVector = "E:\\workplace_kdh\\KG\\transE\\train_result\\entityVector.txt"
    entityVectorList, entityList = loadData(dirEntityVector)
    dirRelationVector = "E:\\workplace_kdh\\KG\\transE\\train_result\\relationVector.txt"
    ...
    testHeadRaw.writeRank("E:\\workplace_kdh\\KG\\transE\\" + "testHeadRaw" + ".txt")
    testHeadRaw.getRelationRank()
    print(testHeadRaw.getMeanRank())
    testHeadRaw.writeRank("E:\\workplace_kdh\\KG\\transE\\" + "testRelationRaw" + ".txt")
    ...
    testTailRaw.writeRank("E:\\workplace_kdh\\KG\\transE\\" + "testTailRaw" + ".txt")
    ...
    testHeadFit.writeRank("E:\\workplace_kdh\\KG\\transE\\" + "testHeadFit" + ".txt")
    testHeadFit.getRelationRank()
    print(testHeadFit.getMeanRank())
    testHeadFit.writeRank("E:\\workplace_kdh\\KG\\transE\\" + "testRelationFit" + ".txt")
    ...
    testTailFit.writeRank("E:\\workplace_kdh\\KG\\transE\\" + "testTailFit" + ".txt")